...
public class DataHolder {
    ...
    public static class Data {
        ...
        final public static String URL = "http://server-orthodontic.rhcloud.com/";
        public static String url_nnet = URL + "model";

        public static String url_news_story1 = URL + "story1";
        public static String url_news_story2 = URL + "story2";
        public static String url_news_story3 = URL + "/story3";
